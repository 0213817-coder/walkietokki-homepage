...
These Terms set out the conditions, procedures, and the respective rights, obligations, and responsibilities of Wikid Production (hereinafter "the Company") and users of the mobile application "WalkieTokki" (hereinafter "the Service").

## Article 2 (Definitions)

1. **Service**: a mobile application that allows cyclists to join groups by channel code or QR code and exchange real-time voice transmissions via the PTT (Push-To-Talk) button on a Bluetooth headset.
2. **User (Member)**: a person who has agreed to these Terms and registered through social sign-in (Apple, Google, or Kakao).
3. **Channel**: a virtual space in which riders sharing the same code or QR code are connected by voice.
4. **Content**: all data arising from use of the Service, including voice signals, nicknames, and ride records.
5. **Pro Subscription**: a paid tier set by the Company that grants extended usage time beyond the free plan.
...
4. The Company may refuse or subsequently terminate a sign-up in any of the following cases:
   ...
   - The User has breached these Terms or applicable law.
   - Identity verification is not possible.

## Article 5 (Obligations of the User)

1. The User shall comply with these Terms, applicable law, and any notices given by the Company.
2. The User shall not engage in any of the following:
   - Defamation or insult of others;
   - Profanity, obscene, hateful, discriminatory, or violent speech;
   - Repeated unsolicited advertising, promotion, religious/political solicitation, or propagandistic statements against the will of other users;
   - Transmission of content inappropriate for minors;
   - Indiscriminate entry into channels by collecting channel codes or QR codes without authorization;
   - Reverse-engineering, hacking, or circumventing the Service;
   - Any other conduct that harms social order or public welfare.
3. While riding, the User shall comply with traffic laws and the duty of safe operation. **The User must remain aware of the surrounding environment even while wearing a headset.**

## Article 6 (Scope of the Service)

The Company provides the following:

1. Group voice transmission (PTT) by channel code or QR code.
2. Automatic saving of ride history (last 30 days displayed).
3. Wind noise reduction options.
4. Nickname configuration and display.
5. Pro Subscription (to be introduced after public launch).
6. Other supplementary services the Company may add.

## Article 7 (Service Hours and Suspension)

1. The Service is in principle available 24 hours a day, 365 days a year.
2. The Company may suspend the Service temporarily where necessary for maintenance, incidents, or urgent security measures. Where possible, the Company will give prior notice; in urgent cases, notice will be given as soon as practicable after the fact.
3. The Service may be temporarily suspended in the following cases:
...
1. The User may withdraw at any time via the in-app "Profile → Delete Account" menu.
2. Upon withdrawal, the following will be processed immediately:
   - Firebase authentication information is permanently deleted;
   - Nickname and sign-up date are permanently deleted;
   - Ride records are anonymized and retained only for statistical purposes.
3. Where a User has materially breached these Terms, the Company may, after prior notice, restrict or terminate the User's membership.
4. Notwithstanding the foregoing, if there is a risk of infringement of others' rights, breach of service security, unlawful activity, or urgent spread of harm, the Company may apply temporary restrictions without prior notice and will notify the reason without delay thereafter.
...
5. **Right of Withdrawal of Subscription**: Under Article 17 of the Korean Act on the Consumer Protection in Electronic Commerce, the User may withdraw a subscription within 7 days of payment. However, due to the nature of digital content, the right of withdrawal may be restricted in the following cases:
   ...
   - Where automatic billing follows the free trial, the refund policy of the respective payment platform applies.
6. **Channels for withdrawal and refund requests**:
   - Apple App Store payments: [reportaproblem.apple.com](https://reportaproblem.apple.com)
   - Google Play payments: per Google Play's refund policy
   - If the User contacts the Company directly regarding a refund or payment, the Company will provide guidance and cooperation within the bounds of applicable law and platform policy.

## Article 10 (Intellectual Property)

1. All intellectual property related to the Service (logos, design, UI, software, etc.) belongs to the Company.
2. The User may not reproduce, transmit, publish, or distribute information obtained through use of the Service without the Company's prior consent.

## Article 10-2 (Protection of Personal Information)

1. The Company strives to protect the User's personal information. Details of the processing of personal information are governed by the separate Privacy Policy.
2. The Privacy Policy has the same effect as these Terms and is available at [walkietokki.com/privacy](https://walkietokki.com/privacy) or in the app under "Settings → Privacy Policy."
3. The Company takes the technical and administrative measures necessary to manage Users' personal information safely in accordance with applicable law.
...
1. Matters not specified in these Terms are governed by the laws of the Republic of Korea.
2. Lawsuits arising from use of the Service may be brought before the court with jurisdiction under the Civil Procedure Act.
3. However, where the User is a consumer, **the district court having jurisdiction over the User's address or residence** prevails in accordance with the Framework Act on Consumers and the Civil Procedure Act.
4. Before initiating litigation, the following dispute resolution bodies are available:
   - Korea Consumer Agency Dispute Settlement Committee ([www.kca.go.kr](https://www.kca.go.kr))
   - Electronic Commerce Dispute Settlement Committee ([www.ecmc.or.kr](https://www.ecmc.or.kr))
   - Personal Information Dispute Mediation Committee ([www.kopico.go.kr](https://www.kopico.go.kr))
...
- **Name**: Wikid Production
- **Representative**: Yohan Yoo
- **Business Registration No.**: 248-02-04034
- **Address**: 30 Nonhyeon-ro 10-gil, Gangnam-gu, Seoul, South Korea
- **Email**: support@walkietokki.com
- **Personal Information Protection Officer**: Yohan Yoo / support@walkietokki.com
